...
public abstract class SimEntity implements Cloneable {
	...
	protected static FutureQueue myFutureQ;
	...
	/**
	 * Send a high priority event to another entity by id number and with
	 * <b>no</b> data. Note that the tag <code>9999</code> is reserved.
	 * 
	 * @param dest
	 *        The unique id number of the destination entity
	...
	/**
	 * Send a high priority event to another entity through a port with a given
	 * name, with <b>no</b> data. Note that the tag <code>9999</code> is
	 * reserved.
	 * 
	 * @param dest
	 *        The name of the port to send the event through
