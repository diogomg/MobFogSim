...
/**
 * Predicates are used to select events from the deferred queue. This class is
 * abstract and must be extended when writing a new predicate. Some standard
 * predicates are provided.<br>
