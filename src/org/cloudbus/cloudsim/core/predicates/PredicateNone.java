...
/**
 * A predicate which will <b>not</b> match any event on the deferred event
 * queue. There is a publicly accessible instance of this predicate in the
 * {@link Simulation} class, called {@link Simulation#SIM_NONE}, so the user
 * does not need to create any new instances. The idea of simulation predicates
 * was copied from SimJava 2.
 * 
