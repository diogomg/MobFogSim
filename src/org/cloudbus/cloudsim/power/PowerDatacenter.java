...
//			CloudSim.cancelAll(getId(), new PredicateType(CloudSimTags.VM_DATACENTER_EVENT));
			CloudSim.cancelAll(CloudSim.getEntity(getId()).getFutureQueue());
			schedule(getId(), getSchedulingInterval(), CloudSimTags.VM_DATACENTER_EVENT);
//			SimEvent ev = scheduleDCEvent(getId(), getSchedulingInterval(), CloudSimTags.VM_DATACENTER_EVENT, null);
//			System.out.println("99 src: "+getId()+" ev: "+ev.toString()+ 
//					" type: " + ev.getType() + " ev time: "+ ev.eventTime() +
//					" sched by: " + ev.scheduledBy() + " data :" + ev.getData());
//			System.out.println("102 "+ CloudSim.getEntity(ev.getSource()).getName());
			return;
		}
...
//				SimEvent ev = sendDCEvent(getId(), getSchedulingInterval(), CloudSimTags.VM_DATACENTER_EVENT);
//				SimEntity se = CloudSim.getEntity(ev.getSource());
//				System.out.println("158 src: "+getId()+" ev: "+ev.toString()+ 
//						" type: " + ev.getType() + " ev time: "+ ev.eventTime() +
//						" sched by: " + ev.scheduledBy() + " data :" + ev.getData());
//				System.out.println("161 "+ CloudSim.getEntity(ev.getSource()).getName());
			}
			else{
