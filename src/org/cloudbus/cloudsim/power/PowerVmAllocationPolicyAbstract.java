...
/**
 * The class of an abstract power-aware VM allocation policy. If you are using
 * any algorithms, policies or workload included in the power package, please
 * cite the following paper: Anton Beloglazov, and Rajkumar Buyya, "Optimal
 ...
 * Centers", Concurrency and Computation: Practice and Experience (CCPE), Volume
 * 24, Issue 13, Pages: 1397-1420, John Wiley & Sons, Ltd, New York, USA, 2012
 * 
...
public abstract class PowerVmAllocationPolicyAbstract extends VmAllocationPolicy {
	 ...
	 * (non-Javadoc)
	 * @see
	 * org.cloudbus.cloudsim.VmAllocationPolicy#deallocateHostForVm(org.cloudbus
	 * .cloudsim.Vm)
	 */
	@Override
	 ...
	 * (non-Javadoc)
	 * @see
	 * org.cloudbus.cloudsim.VmAllocationPolicy#getHost(org.cloudbus.cloudsim
	 * .Vm)
	 */
	@Override
