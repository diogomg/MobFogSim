...
/**
 * This a simple class representing a simple VM allocation policy that does not
 * perform any optimization of the VM allocation. If you are using any
...
public class PowerVmAllocationPolicySimple extends PowerVmAllocationPolicyAbstract {
	 ...
	 * (non-Javadoc)
	 * @see
	 * org.cloudbus.cloudsim.VmAllocationPolicy#optimizeAllocation(java.util
	 * .List)
	 */
	@Override
