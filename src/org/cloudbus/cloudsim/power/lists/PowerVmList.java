...
/**
 * PowerVmList is a collection of operations on lists of power-enabled VMs. If
 * you are using any algorithms, policies or workload included in the power
 * package, please cite the following paper: Anton Beloglazov, and Rajkumar
 * Buyya, "Optimal Online Deterministic Algorithms and Adaptive Heuristics for
 ...
 * (CCPE), Volume 24, Issue 13, Pages: 1397-1420, John Wiley & Sons, Ltd, New
 * York, USA, 2012
 * 
