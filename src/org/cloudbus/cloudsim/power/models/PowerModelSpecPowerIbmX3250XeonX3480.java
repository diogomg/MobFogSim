...
/**
 * The power model of an IBM server x3250 (1 x [Xeon X3480 3067 MHz, 4 cores],
 * 8GB).
 * http://www.spec.org/power_ssj2008/results/res2010q4/power_ssj2008-20101001
 * -00297.html If you are using any algorithms, policies or workload included in
...
public class PowerModelSpecPowerIbmX3250XeonX3480 extends PowerModelSpecPower {
	 ...
	 * (non-Javadoc)
	 * @see
	 * org.cloudbus.cloudsim.power.models.PowerModelSpecPower#getPowerData(int)
	 */
	@Override
