...
/**
 * BwProvisioner is an abstract class that represents the provisioning policy of
 * bandwidth to virtual machines inside a Host. When extending this class, care
 * must be taken to guarantee that the field availableBw will always contain the
 * amount of free bandwidth available for future allocations.
 * 
