...
/**
 * ForwardingRule class is to represent a forwarding table in each switch. This
 * is for VM routing, not host routing. Addresses used here are the addresses of
 * VM.
 * 
 * @author Jungmin Son
				...
				for (Integer flowId : nodes.keySet()) {
					...
					if (node instanceof SDNHost) {
						Log.printLine(thisNode + ": " +
							...
							NetworkOperatingSystem.debugVmIdName.get(colK) + "->" + "(flow:"
							+ flowId + ")" +
