 ...
 * creation request. If start time and finish time is set up, specific CloudSim
 * Event is triggered in datacenter to create and terminate the VM.
 * 
 * @author Jungmin Son
...
public class TimedVm extends Vm {
	...
	public TimedVm(int id, int userId, double mips, int numberOfPes, int ram,
		long bw, long size, String vmm, CloudletScheduler cloudletScheduler, double startTime,
		double finishTime) {
		super(id, userId, mips, numberOfPes, ram, bw, size, vmm, cloudletScheduler);
