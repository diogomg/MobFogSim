...
/**
 * VmSchedulerTimeSharedEnergy is a VMM allocation policy that allocates one or
 * more Pe to a VM, and allows sharing of PEs by time. If there is no free PEs
 * to the VM, allocation fails. Free PEs are not allocated to VMs
 * 
 * @author Rodrigo N. Calheiros
 * @author Anton Beloglazov
 * @author Jungmin Son * @since CloudSim Toolkit 1.0
 */
public class VmSchedulerTimeSharedEnergy extends VmSchedulerTimeShared implements
	PowerUtilizationInterface {
