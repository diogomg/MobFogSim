...
//		AppModule module = new AppModule(userVm.getId(), moduleName, appId, userId, 
//				userVm.getMips(), userVm.getRam(), userVm.getBw()
//				, userVm.getSize(), userVm.getVmm()
//				, userVm.getCloudletScheduler(),userVm.getSelectivityMap());
		
//		AppModule module = new AppModule(userVm);
//		getModules().add(module);
