...
public interface SelectivityModel {
	...
	/**
	 * Function called to check whether incoming tuple can generate an output
	 * tuple.
	 * 
	...
	/**
	 * Gets the Average number of tuples generated per incoming input tuple.
	 * 
	...
	/**
	 * Gets the maximum number of tuples generated per incoming input tuple.
	 * 
