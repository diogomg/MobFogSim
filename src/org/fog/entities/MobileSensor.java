...
public class MobileSensor extends Sensor{
	...
	public MobileSensor(String name, int userId, String appId,
	...
	public MobileSensor(String name, int userId, String appId,
		...
		super(name, userId, appId, gatewayDeviceId, latency, geoLocation,
				transmitDistribution, tupleType);
		// TODO Auto-generated constructor stub
	}

	public MobileSensor(String name, String tupleType, int userId,
			String appId, Distribution transmitDistribution) {
