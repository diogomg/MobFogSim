...
public class FogEntityFactory {
	...
	public static FogDevice createFogDevice(String name, int mips, double uplinkBandwidth,
		double downlinkBandwidth, double latency, double ratePerMips) {
		...
		PowerHost host = new PowerHost(hostId, new RamProvisionerSimple(ram),
			...
			new StreamOperatorScheduler(peList), new PowerModelLinear(100, 40));
